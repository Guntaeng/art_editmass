...
Suite Setup    Login dohome and click web art(Approve avp) 
Test Template        Approve art AVP 
...
Approve art AVP
    ...
    Wait And Click Element    //*[text()='รอ AVP พิจารณา']//parent::div
